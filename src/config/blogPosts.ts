...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: "zbe-barcelona-que-coches-pueden-entrar",
    title: "ZBE Barcelona: ¿puede entrar tu coche? Guía práctica 2026",
    metaTitle: "ZBE Barcelona 2026: ¿Qué coches pueden entrar? Guía completa | Aelia Motor",
    metaDescription: "Descubre si tu coche puede circular por la Zona de Bajas Emisiones de Barcelona en 2026. Etiquetas DGT, excepciones, multas y soluciones para tu vehículo.",
    excerpt: "La Zona de Bajas Emisiones de Barcelona afecta a miles de conductores del Vallès. Te explicamos quién puede entrar, qué pasa si no tienes etiqueta y qué soluciones existen.",
    date: "2026-03-05",
    readTime: 7,
    category: "Normativa",
    keywords: ["ZBE Barcelona", "zona bajas emisiones Barcelona", "etiqueta DGT", "ZBE Ripollet", "coches sin etiqueta Barcelona", "multa ZBE Barcelona"],
    image: "/images/bg-escape.jpg",
    imageAlt: "Vehículos circulando en zona urbana",
    content: [
      { type: "p", text: "Desde enero de 2023 la Zona de Bajas Emisiones (ZBE) de Barcelona restringe la circulación de los vehículos más contaminantes dentro de las rondas. Si vives en Ripollet, Cerdanyola, Barberà del Vallès o cualquier municipio del Vallès Occidental y te desplazas a Barcelona, esto te afecta directamente." },
      { type: "h2", text: "¿Qué es la ZBE de Barcelona?" },
      { type: "p", text: "Es un área de 95 km² dentro de las rondas de Barcelona donde solo pueden circular los vehículos con etiqueta ambiental de la DGT. El objetivo es reducir la contaminación y mejorar la calidad del aire. Las restricciones se aplican de lunes a viernes, de 7:00 a 20:00 horas." },
      { type: "h2", text: "¿Qué etiqueta necesita mi coche?" },
      { type: "p", text: "La DGT clasifica los vehículos según su nivel de emisiones con 4 etiquetas:" },
      { type: "ul", text: "", items: [
        "Etiqueta 0 (azul): Vehículos eléctricos e híbridos enchufables con más de 40 km de autonomía eléctrica. Sin restricciones.",
        "Etiqueta ECO (verde/azul): Híbridos no enchufables, gas natural y GLP. Sin restricciones.",
        "Etiqueta C (verde): Gasolina matriculados desde 2006 y diésel desde 2014. Pueden circular.",
        "Etiqueta B (amarilla): Gasolina desde 2000 y diésel desde 2006. Pueden circular con restricciones en episodios de alta contaminación.",
        "Sin etiqueta: Gasolina antes de 2000 y diésel antes de 2006. NO pueden entrar en la ZBE.",
      ]},
      { type: "h2", text: "¿Y si mi coche no tiene etiqueta?" },
      { type: "p", text: "Si tu coche no tiene etiqueta ambiental y necesitas entrar en Barcelona, tienes varias opciones:" },
      { type: "h3", text: "1. Solicitar un permiso temporal" },
      { type: "p", text: "El Ayuntamiento de Barcelona permite solicitar hasta 10 autorizaciones al año para vehículos sin etiqueta a través del registro metropolitano de vehículos. Es una solución puntual, no permanente." },
      { type: "h3", text: "2. Mejorar las emisiones de tu vehículo" },
      { type: "p", text: "En algunos casos es posible reducir las emisiones de tu coche para que cumpla los valores necesarios. Servicios como la limpieza del sistema de escape, cambio de catalizador, revisión del sistema de inyección o una descarbonización del motor pueden ayudar a que tu vehículo pase la ITV con valores más bajos." },
      { type: "h3", text: "3. Adaptar tu coche a GLP (autogas)" },
      { type: "p", text: "Convertir un coche de gasolina a GLP le otorga la etiqueta ECO. Es una inversión de entre 1.500 y 2.500€ que además reduce el coste de combustible a la mitad. No todos los modelos son compatibles, pero es una opción cada vez más popular." },
      { type: "h3", text: "4. Cambiar de vehículo" },
      { type: "p", text: "Si tu coche es anterior al año 2000 (gasolina) o 2006 (diésel), puede que la inversión en reparaciones no compense. En ese caso, cambiar a un vehículo con etiqueta C o superior es la opción más práctica a largo plazo." },
      { type: "h2", text: "¿Cuánto es la multa por entrar sin etiqueta?" },
      { type: "p", text: "Circular por la ZBE sin autorización ni etiqueta supone una multa de 200€. Las cámaras del sistema detectan automáticamente las matrículas, así que no es cuestión de suerte." },
      { type: "h2", text: "¿Cómo saber la etiqueta de mi coche?" },
      { type: "p", text: "Puedes consultar la etiqueta ambiental de tu vehículo en la web de la DGT (sede.dgt.gob.es) introduciendo tu matrícula. También puedes pasar por nuestro taller y te lo confirmamos en el momento." },
      { type: "h2", text: "¿Cómo te ayudamos en Aelia Motor?" },
      { type: "p", text: "En nuestro taller de Ripollet podemos revisar el estado de emisiones de tu coche, realizar una limpieza del sistema de escape y optimizar el motor para reducir emisiones. También hacemos la revisión pre-ITV completa para asegurarnos de que todo está dentro de los valores legales." },
      { type: "p", text: "Si no sabes qué etiqueta tiene tu coche o quieres valorar opciones para seguir circulando por Barcelona, pásate por el taller o escríbenos por WhatsApp. Te asesoramos sin compromiso." },
    ],
  },
];
